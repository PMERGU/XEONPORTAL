...
public class PurchaseOrderDTO implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!Objects.equals(id, purchaseOrderDTO.id))
			return false;
	...
	public String toString() {
		return "PurchaseOrderDTO{" + "id=" + id + ", state='" + state + "'" + ", serviceLevel='" + serviceLevel + "'" + ", captureDate='" + captureDate + "'" + ", deliveryDate='" + deliveryDate + "'" + ", poNumber='" + poNumber + "'" + ", reference='" + reference + "'" + ", customerType='" + customerType + "'" + ", shipToType='" + shipToType + "'" + ", telephone='" + telephone + "'" + ", collective='" + collective + "'" + ", accountReference='" + accountReference + "'" + ", modeOfTransport='" + modeOfTransport + "'" + ", carrierVesselName='" + carrierVesselName + "'" + ", carrierVesselNumber='" + carrierVesselNumber + "'" + ", pickUpType='" + pickUpType + "'" + '}';
	}
}
