...
public class PoLineResource {
    ...
    public ResponseEntity<PoLine> createPoLine(@Valid @RequestBody PoLine poLine) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/poLines/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert("poLine", result.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PoLine> updatePoLine(@Valid @RequestBody PoLine poLine) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("poLine", poLine.getId().toString()))
            .body(result);
    }
    ...
    @RequestMapping(value = "/poLines",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<PoLine>> getAllPoLines(Pageable pageable)
     ...
     */
    @RequestMapping(value = "/poLines/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
