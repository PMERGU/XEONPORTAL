...
public class PurchaseOrderResource {
	...
	public Callable<ResponseEntity<PurchaseOrder>> createPurchaseOrder(@Valid @RequestBody PurchaseOrder purchaseOrder, HttpServletRequest request) throws URISyntaxException {
		...
		return () -> {
			...
			// captured by logic
			User user;
			User capturedBy = null; // when a xeon user captures a order on
	...
	// @Timed
	// public ResponseEntity<PurchaseOrder> updatePurchaseOrder(@Valid
	// @RequestBody PurchaseOrder purchaseOrder, HttpServletRequest request)
	// throws URISyntaxException {
	// log.debug("REST request to update PurchaseOrder : {}", purchaseOrder);
	// PurchaseOrder previous =
	// purchaseOrderService.findOne(purchaseOrder.getId());
	// if(previous.getState().equals(PoState.PROCESSED)) {
	// return ResponseEntity.badRequest()
	// .headers(HeaderUtil.createFailureAlert("purchaseOrder","poNumber",
	// String.format("This purchase order has already been processed and cant be
	// updated.", purchaseOrder.getPoNumber())))
	// .body(purchaseOrder);
	// }else if(!previous.getPoNumber().equals(purchaseOrder.getPoNumber())){
	// if(purchaseOrderRepository.findFirstByPoNumber(purchaseOrder.getPoNumber())
	// != null){
	// return ResponseEntity.badRequest()
	// .headers(HeaderUtil.createFailureAlert("purchaseOrder","poNumber",
	// String.format("A PO with the number #%s already exists in the system.
	// Please double check poNumber or double check the dashboard",
	...
	// return ResponseEntity.badRequest()
	// .headers(HeaderUtil.createFailureAlert("purchase order",
	// purchaseOrder.getId().toString(), "Cant update an already processed
	// order. Please contact Xeon customer team"))
	// .body(purchaseOrder);
	// }
	// if (purchaseOrder.getId() == null) {
	...
	// .headers(HeaderUtil.createEntityUpdateAlert("purchaseOrder",
	 ...
	 */
	@RequestMapping(value = "/purchaseOrders", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	...
	@Timed
	public Callable<ResponseEntity<HandlingUnitDetails>> getHuDetails(@PathVariable String id, @PathVariable(value = "deliveryNo") String deliveryNo, Pageable pageable) throws Exception {
	 ...
	 */
	@RequestMapping(value = "/purchaseOrders/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	 ...
	 */
	@RequestMapping(value = "/purchaseOrders/{id}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
