...
/**
 * <p>
 * Java class for FormattingType complex type.
 *
 * <p>
...
@XmlType(name = "FormattingType", propOrder = { "content" })
public class FormattingType {

	@XmlElementRefs({ @XmlElementRef(name = "charParams", namespace = "http://www.abbyy.com/FineReader_xml/FineReader10-schema-v1.xml", type = JAXBElement.class, required = false), @XmlElementRef(name = "wordRecVariants", namespace = "http://www.abbyy.com/FineReader_xml/FineReader10-schema-v1.xml", type = JAXBElement.class, required = false) })
	@XmlMixed
	 ...
	 * {@link JAXBElement }{@code <}{@link FormattingType.WordRecVariants }
	 * {@code >} {@link String }
	 *
	 *
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "wordRecVariant" })
	public static class WordRecVariants {
		 ...
		 * <CODE>set</CODE> method for the wordRecVariant property.
		 *
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
