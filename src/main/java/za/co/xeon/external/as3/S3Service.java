...
public class S3Service {
	...
	public String uploadFile(String fileName, InputStream inputStream) {
		try {
			...
			PutObjectResult por = s3client.putObject(new PutObjectRequest(s3Settings.getBucketName(), fileName, inputStream, new ObjectMetadata()));
	...
	public ObjectListing listFolder(String folder) {
		...
		ObjectListing listing = s3client.listObjects(new ListObjectsRequest().withBucketName(s3Settings.getBucketName()).withPrefix(folder));
		return listing;
	}
}
