...
public class CustOrdersRFC {
	 ...
	 *            "POD status on header level"
	 */
	public CustOrdersRFC(String imCustomer, List<ImDateR> imDateR, String imStatusPod) {
		this.imCustomer = imCustomer;
		this.imDateR = imDateR;
		this.imStatusPod = imStatusPod;
	}

	public List<GtCustOrders> getGtCustOrders() {
		return gtCustOrders;
	}
	 ...
	 */
	@Export
	@Parameter(value = "GT_CUST_ORDERS", type = ParameterType.TABLE_STRUCTURE)
