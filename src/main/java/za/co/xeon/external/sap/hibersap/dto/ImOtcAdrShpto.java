...
public class ImOtcAdrShpto {
    ...
    public ImOtcAdrShpto(String title, String name, String name2, String street, String city, String district, String region, String transpzone, String country, String postlCode, String pobxPcd, String pobxCty, String telephone, String faxNumber) {
        this.title = title;
        this.name = name;
        this.name2 = name2;
        this.street = street;
    ...
    /**
     * @return "Transpzone" - "Transportation zone to or from which the goods are delivered" */
