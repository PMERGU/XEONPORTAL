...
public class CompanyDto implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (name != null ? !name.equals(that.name) : that.name != null)
			return false;
		if (sapId != null ? !sapId.equals(that.sapId) : that.sapId != null)
			return false;
		if (type != that.type)
			return false;
		if (!Arrays.equals(background, that.background))
			return false;
	...
	public String toString() {
		return "CompanyDto{" + "id=" + id + ", name='" + name + '\'' + ", sapId='" + sapId + '\'' + ", type=" + type + ", background=" + Arrays.toString(background) + ", backgroundContentType='" + backgroundContentType + '\'' + '}';
	}
}
