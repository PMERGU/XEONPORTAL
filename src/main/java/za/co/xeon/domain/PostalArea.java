...
public class PostalArea implements Serializable {
	...
	public String toString() {
		return "PostalArea{" + "id=" + id + ", suburb='" + suburb + '\'' + ", postalCode=" + postalCode + ", city='" + city + '\'' + ", province='" + province + '\'' + ", country='" + country + '\'' + '}';
	}

	public String toStringShort() {
		return "PostalArea{" + "postalCode=" + postalCode + ", hub='" + hub + '\'' + ", plant='" + plant + '\'' + '}';
	}
}
