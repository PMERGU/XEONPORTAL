...
angular.module('portalApp')
	.controller('IOReportController', function($scope, $log, $state, $stateParams, $http, Company, IOReport,  Principal) {
		...
		$scope.loadAll = function() {
			...
			if ($stateParams.queryType === undefined || $stateParams.queryType === null || $stateParams.queryType === "ALL") {
				$scope.ioReport.sapId = $scope.selected.company.sapId;
				//				$scope.stockReport.
				$log.debug("test Status: " + $scope.podStatus);
				IOReport.save($scope.ioReport, onSaveSuccess, onSaveError);
		...
		$scope.downloadPdf = function() {
			...
			if ($stateParams.queryType === undefined || $stateParams.queryType === null || $stateParams.queryType === "ALL") {
				...
				$scope.ioReport.sapId = $scope.selected.company.sapId;
				$http.post('api/iorReport/download/', $scope.ioReport, {
					responseType : 'arraybuffer'
				}).then(function(response) {
					var fileName = "io_report.pdf";
