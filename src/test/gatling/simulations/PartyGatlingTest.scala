...
class PartyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Party entity")
        ...
        .repeat(2) {
            ...
            .post("/api/partys")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "houseNumber":"SAMPLE_TEXT", "streetName":"SAMPLE_TEXT", "district":"SAMPLE_TEXT", "postalCode":"0", "city":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "reference":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
